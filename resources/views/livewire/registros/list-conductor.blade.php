<div>
    <div class="card">
        <div class="card-header col-md-12">
            <div class="row">
                <div  class="col-md-4">
                    <a href="#" wire:click.prevent="agregarCliente" class="btn btn-secondary btn-block"> <i class="fa fa-plus-circle mr-1"></i> Registrar conductor</a>
                </div>
                <div  class="col-md-8">
        ...
        @if ($conductores->count())
            <div class="card-body table-responsive-sm">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($conductores as $index =>$cliente)
                            <tr>
                                <td>{{$index+1}}</td>
                ...
                <br>
                <div class="footer">{{$conductores->links()}}</div> 
            </div>
